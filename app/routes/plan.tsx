    ...
    <div className="container mx-auto px-4 py-16 max-w-7xl">
      ...
      <div className="text-center my-16">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          Choose the perfect plan to accelerate your AI career journey. All plans include our core features.
        </p>
            ...
            <CardContent className="flex-1">
              <div className="mb-6">
                ...
                {isAnnual && plan.price.monthly > 0 && (
                  <p className="text-sm text-muted-foreground mt-1">${plan.price.monthly}/mo when billed monthly</p>
                )}
              </div>
                ...
                <td className="py-4 px-6 flex items-center">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="w-64">Number of job applications you can submit with AI optimization per month</p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </td>
